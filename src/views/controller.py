...
class Controller(object):
	...
	####	
	#Everything past this point needs to be refatored, and moved to various other objects.
	#None of it should belong in the controller, but is kept here so as not to break the 
	#current state of uniquity. 	
	####	
